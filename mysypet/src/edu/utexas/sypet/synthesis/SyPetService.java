...
public class SyPetService {
	...
	private void initSyPet(List<Pair<String, String>> srcs, String tgt, int localMax) throws IOException{
	...
	public String doQuery(List<Pair<String, String>> srcs, String tgt) throws IOException {
		if (SypetEnv.debug) {
